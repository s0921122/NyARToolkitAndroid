 ...
 * Android SDK 1.6 platform 以上
 * A虎＠(nyatla)氏の NyARToolkit for Java を基盤に作られているライブラリです
 ...
 * 3D グラフィックスとの合成などは各自で実装する事が可能です
 ...
 # Android SDK 1.6 platform or higher
 # This library is made based on NyARToolkit for Java of nyatla.
